...
import { GET_DAILY_RESERVATIONS,NOTUPDATED, RESTAURANT_UPDATING , CLEAR_RESTAURANT_NOW, DELETERESTAURANTMENUIMAGE, DELETERESTAURANTCAROUSELIMAGE, IMAGES_LOADING,LOADING_NEWDATA,GET_RECENT_COMMENTS,UPLOADRESTAURANTMENUS, ADD_LAYOUT, UPLOADPRIMARYIMG, GET_RESTAURANT, UPLOADRESTAURANTIMAGES, GET_ACTIVEROOMS, GET_WEEKLY_RESERVATIONS, RESET_SERVERRESPONSE, MAKE_ROOM_UNACTIVE, MAKE_ROOM_ACTIVE,  DASHBOARD_LOADING , FAILED_DASHBOARD, UPDATE_RESTAURANT,  UPDATE_ROOMDASHBOARD, UPDATE_LAYOUT, GET_MONTHLY_RESERVATIONS, GET_LAYOUTSDASHBOARD, DELETE_ROOM, GET_ROOMDASHBOARD, GET_RECENT_RESERVATIONS, REMOVE_ROOM, GET_PLATTEGROND, DELETE_LAYOUT } from "./types";
